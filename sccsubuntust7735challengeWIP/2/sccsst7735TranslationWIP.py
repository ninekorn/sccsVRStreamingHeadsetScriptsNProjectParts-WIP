...
while someswtc == True:
    ...
    if somecounterForzoomSwtc == 0:           
        if somecounterForzoom > somecounterForzoomMax: #somecounterForzoomMaxClose:
            ...
            image = someoriginalimage.resize((int(someotherw),int(someotherh)))
            image = someoriginalimage.crop(((somefinalwidth * 1), (someremainsheight + somefinalheight) * 1, (somefinalwidth*1) + (width), ((someremainsheight + somefinalheight) * 1) + (height)))
