...
namespace Jitter.Dynamics
{
    ...
    public class RigidBody : IBroadphaseEntity, IDebugDrawable, IEquatable<RigidBody>, IComparable<RigidBody>
    {
        ...
        public RigidBody(Shape shape, int rIndex,int rTag)
            : this(shape, new Material(), false, rIndex, rTag)
        {
        ...
        public RigidBody(Shape shape, Material material, int rIndex, int rTag)
            :this(shape,material,false, rIndex, rTag)
        {
            //
            shape.setrIndex(rIndex);
            shape.setrTag(rTag);
            //



            //Console.WriteLine("rIndex:" + rIndex, rTag);
        }
        ...
        public RigidBody(Shape shape, Material material, bool isParticle,int rIndex, int rTag)
        {
